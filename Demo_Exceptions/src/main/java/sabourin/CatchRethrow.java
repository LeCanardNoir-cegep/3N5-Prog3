...
public class CatchRethrow {
    ...
    // DONE TODO 6 Parfois on veut attraper des exceptions pour les relancer ensuite ou alors relancer la nôtre
    public static void main( String[] args ) {
        for (int i = 0 ; i < 10; i++) {
            try {
                ...
                System.out.println("ça a cassé: " + e.getMessage());
            }
        }
    }

    // DONE TODO 7 Catch & (Re)Throw
