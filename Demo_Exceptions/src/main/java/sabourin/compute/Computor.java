...
public class Computor {
    // DONE TODO 3 On peut aussi créer nos propres   ⬇ ⬇ ⬇ ⬇ ⬇  classes d'exception
    public Computor() throws ParseException, MonException, FileNotFoundException {
        // DONE TODO 4 Décommenter une seule ligne à la fois et exécuter chaque fois
        //divide(5,0);
        //arrayAccess(5);
        //arrayAccessCaught(5);
        //plusieursTryCatch();
